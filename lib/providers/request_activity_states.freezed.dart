...
part of 'request_activity_states.dart';
...
/// @nodoc
mixin _$RequestActivityState<T> {
  @optionalTypeArgs
...
/// @nodoc
abstract class $RequestActivityStateCopyWith<T, $Res> {
  factory $RequestActivityStateCopyWith(RequestActivityState<T> value,
          $Res Function(RequestActivityState<T>) then) =
      _$RequestActivityStateCopyWithImpl<T, $Res, RequestActivityState<T>>;
}

/// @nodoc
class _$RequestActivityStateCopyWithImpl<T, $Res,
        $Val extends RequestActivityState<T>>
    implements $RequestActivityStateCopyWith<T, $Res> {
  _$RequestActivityStateCopyWithImpl(this._value, this._then);
...
class __$$_InitialCopyWithImpl<T, $Res>
    extends _$RequestActivityStateCopyWithImpl<T, $Res, _$_Initial<T>>
...
class _$_Initial<T> implements _Initial<T> {
  ...
  @override
  String toString() {
    return 'RequestActivityState<$T>.initial()';
  }
...
abstract class _Initial<T> implements RequestActivityState<T> {
...
class __$$_DataCopyWithImpl<T, $Res>
    extends _$RequestActivityStateCopyWithImpl<T, $Res, _$_Data<T>>
...
class _$_Data<T> implements _Data<T> {
  ...
  @override
  String toString() {
    return 'RequestActivityState<$T>.data(data: $data)';
  }
...
abstract class _Data<T> implements RequestActivityState<T> {
...
class __$$_ErrorCopyWithImpl<T, $Res>
    extends _$RequestActivityStateCopyWithImpl<T, $Res, _$_Error<T>>
...
class _$_Error<T> implements _Error<T> {
  ...
  @override
  String toString() {
    return 'RequestActivityState<$T>.error(error: $error, stack: $stack)';
  }
...
abstract class _Error<T> implements RequestActivityState<T> {
...
class __$$_LoadingCopyWithImpl<T, $Res>
    extends _$RequestActivityStateCopyWithImpl<T, $Res, _$_Loading<T>>
...
class _$_Loading<T> implements _Loading<T> {
  ...
  @override
  String toString() {
    return 'RequestActivityState<$T>.loading()';
  }
...
abstract class _Loading<T> implements RequestActivityState<T> {
